...
```
python ./check_provirus.py -it ./sample_id_step1_genomad_step1_checkv/quality_summary.tsv -ifc ./sample_id_step1_genomad_step1_checkv/proviruses.fna -ifg sample_id_step1_genomad_virus.fna -o sample_id_no_provirus_virus.fna -og sample_id_provirus_part1.fna -ogc sample_id_provirus_part2.fna
```
